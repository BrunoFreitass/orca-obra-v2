"""
Script de correção automática para o OrçaObra AI.
Rode este arquivo na pasta raiz do projeto (onde está app.py).
Ele vai substituir core/reporter.py e app.py pelas versões corrigidas.
"""
import os

# =============================================================================
# CORREÇÃO 1: core/reporter.py — Totais do Excel preenchidos com valores
# =============================================================================
REPORTER_CORRIGIDO = r"""from openpyxl import Workbook
...
# =============================================================================
# CORREÇÃO 2: app.py — Alerta proeminente de paredes subestimadas + botão ajuste
# =============================================================================
APP_CORRIGIDO = r"""import streamlit as st
import os
...
if __name__ == "__main__":
    print("=" * 60)
    print("  ORÇAOBRA AI - APLICADOR DE CORREÇÕES")
    print("=" * 60)
    print()

    # Verifica se está na pasta correta
    if not os.path.exists("app.py"):
        print("❌ ERRO: Este script deve ser executado na pasta raiz do projeto")
        print("   (onde está o arquivo app.py)")
        print(f"   Pasta atual: {os.getcwd()}")
        exit(1)

    # 1. Substitui core/reporter.py
    reporter_path = os.path.join("core", "reporter.py")
    print(f"📄 Substituindo {reporter_path}...")
    with open(reporter_path, "w", encoding="utf-8") as f:
        f.write(REPORTER_CORRIGIDO)
    print(f"   ✅ {reporter_path} atualizado!")

    # 2. Substitui app.py
    print(f"📄 Substituindo app.py...")
    with open("app.py", "w", encoding="utf-8") as f:
        f.write(APP_CORRIGIDO)
    ...
    print("  1. Feche o terminal do Streamlit (Ctrl+C)")
    print("  2. Abra um novo terminal")
    print("  3. Ative o ambiente virtual: .venv\\Scripts\\activate")
    print("  4. Rode: streamlit run app.py")
    print()
    print("O que mudou:")
    print("  • Excel: coluna 'Total (R$)' agora aparece preenchida")
    print("  • Alerta vermelho quando metros de parede estiverem abaixo do esperado")
    print("  • Botão '⚡ Ajustar para X m' para corrigir automaticamente")
