...
class ItemOrcamento:
    ...
    fase: "Obra Bruta" (estrutura/fechamento -- precisa estar pronto
    antes do acabamento) ou "Acabamento" (revestimentos, pintura,
    pontos finais). Usado pra agrupar e mostrar subtotais separados
    na tela e nos documentos gerados (ver core/calculator.py)."""
    ...
    def to_dict(self) -> dict:
        """Formato dict (Tipo/Material/Quantidade/Preco_Unit/Total/Fase) que
