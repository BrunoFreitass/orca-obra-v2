...
CONSUMO_CIMENTO_SACO_POR_M2 = Preco(7, "SINAPI - composição contrapiso", "2026-06")
...
PRECOS_PONTO_ELETRICO = {
    "Econômico": Preco(85.00, "Pesquisa de mercado - ponto elétrico simples", "2026-06"),
    "Médio": Preco(110.00, "Pesquisa de mercado - ponto elétrico padrão médio", "2026-06"),
    "Alto Padrão": Preco(150.00, "Pesquisa de mercado - ponto elétrico com acabamento premium", "2026-06"),
}
PRECOS_PONTO_HIDRAULICO = {
    "Econômico": Preco(110.00, "Pesquisa de mercado - ponto hidráulico simples", "2026-06"),
    "Médio": Preco(140.00, "Pesquisa de mercado - ponto hidráulico padrão médio", "2026-06"),
    "Alto Padrão": Preco(190.00, "Pesquisa de mercado - ponto hidráulico com acabamento premium", "2026-06"),
}
PRECOS_COBERTURA = {
    "Telhado": {
...
PRECO_ACO_FALLBACK = Preco(8.38, "Média nacional SINAPI - insumo 32 (aço CA-50), usado se o estado não tiver preço próprio coletado", "2026-04")

# =====================================================================
# FATOR REGIONAL E ACO -- fixos para Roraima (RR), unico estado
# atendido pelo OrçaObra neste momento (ver core/coeficientes.py:
# antes desta simplificacao, isto era uma tabela com todos os 27
# estados; reduzido a proposito para so o RR, ja que expandir pra
# outros estados nao esta no escopo atual do produto).
# =====================================================================
...
def data_mais_antiga() -> str:
    ...
    mais velho usado no motor de calculo esta. Usado no rodape do PDF
    (core/proposta_pdf.py) para avisar o cliente da data de referencia
    real do orcamento, nao so a data em que foi gerado."""
    ...
    return min([
        _mais_antiga(
            ...
            PRECOS_PONTO_ELETRICO, PRECOS_PONTO_HIDRAULICO,
            PRECOS_COBERTURA["Telhado"], PRECOS_COBERTURA["Laje"],
            PRECO_BLOCO_CERAMICO, PRECO_ARGAMASSA_KG, PRECO_TINTA_L,
            PRECO_CIMENTO_SACO, PRECO_AREIA_M3, PRECO_BRITA_M3, PRECO_ACO_FALLBACK,
