...
def calcular_materiais(dados, padrao, tipo_cobertura="Telhado"):
    ...
    itens = [
        ...
        ItemOrcamento("Material", "Bloco Cerâmico 14x19x29",
                      ...
                      fase="Obra Bruta"),
        ItemOrcamento("Material", "Reboco (chapisco + emboço)",
                      round(d.area_parede * margem, 2),
                      obter_preco("reboco", PRECO_REBOCO_M2).valor * fator_regional,
                      fase="Obra Bruta"),
        ItemOrcamento("Material", "Impermeabilização (Área Molhada)",
                      round(d.area_piso_molhado * margem, 2),
                      obter_preco("impermeabilizacao", PRECO_IMPERMEABILIZACAO_M2).valor * fator_regional,
                      fase="Obra Bruta"),
        ...
        ItemOrcamento("Material", "Argamassa AC-II",
                      ...
                      fase="Acabamento"),
        ItemOrcamento("Material", "Rejunte",
                      round(d.area_piso_total * CONSUMO_REJUNTE_KG_POR_M2.valor * margem, 2),
                      obter_preco("rejunte", PRECO_REJUNTE_KG).valor * fator_regional,
                      fase="Acabamento"),
        ItemOrcamento("Material", "Forro de Gesso",
